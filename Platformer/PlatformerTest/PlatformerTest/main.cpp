	...
	void checkCollisionWithMap(float Dx, float Dy, float time)
	{
		if (name == "EasyEnemy" || name == "EasyShootEnemy") {
			for (int i = 0; i < obj.size(); i++)
			{
				...
				if (getRect().intersects(obj[i].rect))
				{
					if (obj[i].name == "solid" || obj[i].name == "solidInvis")//���� ��������� �����������
					{
						if (Dy > 0)
						{
...
public:
	...
	Bullet(Image& image, String Name, Level& lvl, float X, float Y, int W, int H, float tX, float tY) :Entity(image, Name, X, Y, W, H) {//�� ��� ��, ������ ����� � ����� ��������� ������ (int dir)

		obj = lvl.GetObjects("solid");
		obj2 = lvl.GetObjects("solidInvis");//�������������� .�������� ������ ������� ��� �������������� ���� � ������
		x = X;
		y = Y;
		targetX = tX;
		targetY = tY;
	...
	void update(float time)
	{
		...
		for (int i = 0; i < obj.size(); i++) {//������ �� �������� solid
			for (int i = 0; i < obj2.size(); i++) {
				if (getRect().intersects(obj[i].rect) || getRect().intersects(obj2[i].rect)) //���� ���� ������ ���������� � �����,
				{
...
void menu(RenderWindow& window)
{
	...
	while (Menu)
	{
		...
		if (Mouse::isButtonPressed(Mouse::Left))
		{
			if (menuNum == 1) { continuee = 1; Menu = 0; gamerun = 1; gamestart = true; }//���� ������ ������ ������, �� ������� �� ���� 
			if (menuNum == 2) {bought[0] = 0;bought[1] = 0; Menu = 0; gamerun = 1; gamestart = true; }
			if (menuNum == 3) { AdvMenu = 1; RaznMenu = 1; levelchange(window);}//���� ������ ������ ������, �� ������� �� ���� 
...
bool startGame(RenderWindow& window, int& numberLevel,bool& gamestart) {
	...
	Image BulletImage;//����������� ��� ����
	BulletImage.loadFromFile("images/Bullet1.png");//��������� �������� � ������ �����������

	Image BulletAWPImage;//����������� ��� ����
	BulletAWPImage.loadFromFile("images/BulletAWP.png");//��������� �������� � ������ �����������

	Image BulletP90Image;//����������� ��� ����
	BulletP90Image.loadFromFile("images/BulletP90.png");//��������� �������� � ������ �����������

	Image BulletSHGImage;//����������� ��� ����
	BulletSHGImage.loadFromFile("images/BulletShootGun.png");//��������� �������� � ������ �����������

	Image BulletEnemyImage;//����������� ��� ����
	BulletEnemyImage.loadFromFile("images/BulletEnemy.png");//��������� �������� � ������ �����������
	...
	while (window.isOpen())
	{
		...
		for (it = entities.begin(); it != entities.end(); it++)//���������� �� ��-��� ������
		{
			...
			for (it2 = entities.begin(); it2 != entities.end(); it2++)
			{
				...
				if (((*it)->getRect().intersects((*it2)->getRect())) && ((*it)->name == "EasyShootEnemy") && ((*it2)->name == "Bullet"))//���� ����������� ��� ������� � ��� �����
				{
					float tmpX, tmpY;
					int randd;
					//cout << damage << endl;
			...
			for (it2 = entities.begin(); it2 != entities.end(); it2++)
			{
				...
				if (((*it)->getRect().intersects((*it2)->getRect())) && ((*it)->name == "EasyEnemy") && ((*it2)->name == "EasyShootEnemy"))//���� ����������� ��� ������� � ��� �����
				{
					(*it)->dx *= -1;//������ ����������� �������� �����
					(*it)->sprite.scale(-1, 1);//�������� ������ �� �����������
				}
